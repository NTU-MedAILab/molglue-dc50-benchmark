# Molecular-glue DC50 confirmatory protocol v1

Status: frozen CPU core protocol  
...
- ChEMBL candidates, weak/censored labels and the 96-row unlabeled panel are
  outside the CPU v1 primary analysis.
...
prospective external validation. The 96-row unlabeled panel remains a
prediction-ranking set and cannot supply an external performance estimate.
